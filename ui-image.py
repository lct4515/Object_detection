...
def file_select():
    ...
    s = img.size
    re_s = img.resize((300,192))  # 重置大小
    photo1 = ImageTk.PhotoImage(re_s)
    thelabel.configure(image=photo1)
...
def img_recognition():
    ...
    thelabe2.configure(image=photo2)
    root.mainloop()
